...
public abstract class ListViewsStyleBase extends AnchorPane {
	 ...
	 protected final AnchorPane anchorPane;
	    ...
	    protected final JFXListView<Object> master;
	    protected final VBox datasetBox1;
	    protected final JFXListView<Object> dataset1;
	    protected final VBox datasetBox2;
	    protected final JFXListView<Object> dataset2;
	    ...
	    public ListViewsStyleBase() {
	        ...
	        masterBox = new VBox();
	        master = new JFXListView<>();
	        datasetBox1 = new VBox();
	        dataset1 = new JFXListView<>();
	        datasetBox2 = new VBox();
	        dataset2 = new JFXListView<>();
